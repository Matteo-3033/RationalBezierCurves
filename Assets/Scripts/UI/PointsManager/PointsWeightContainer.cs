...
public class PointsWeightContainer : MonoBehaviour
{
    [SerializeField] private GameObject pointWeightTemplate;
    
    private readonly List<GameObject> _rows = new();

    private void Awake()
    {
        pointWeightTemplate.SetActive(false);
    }
    ...
    {
        var obj = Instantiate(pointWeightTemplate, transform);
        obj.SetActive(true);
        _rows.Add(obj);
        var pointCoords = obj.GetComponent<PointWeight>();
